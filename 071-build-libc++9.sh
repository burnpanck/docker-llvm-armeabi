...
# HACK: bleeding-edge checkout
export SRC_ROOT=${SRC_ROOT}/llvm-project
...
(
    ...
    cmake ${LLVM_CMAKE_CONFIG[@]} \
       ...
       -DLIBCXX_CXX_ABI_INCLUDE_PATHS="${SRC_ROOT}/libcxxabi/include" \
...
rm -r ${BUILD_ROOT}/libunwind || false
...
rm -r ${BUILD_ROOT}/libcxxabi || false
